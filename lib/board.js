...
// TODO: This is causing errors and I'm not sure if it is even getting used
...
Board.prototype.addPiece = function(id, loc, active) {
    ...
    console.log('board.addPiece emit.addPiece');

    // TODO: Need to make sure the board is subscribing to all the events correctly
    //
