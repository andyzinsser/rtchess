...
function makeClickBoard(boardView) {
    console.log('boardView.makeClickBoard');
    return function(e) {
...
function findBoardPos(e) {
    ...
    // FF Fix of e.offsetX being undefined
...
function clickBoard(e, boardView) {
    ...
    console.log('boardView.clickBoard emit moveRequest');
...
function makeEvents(boardView) {
    // TODO: Make sure this is firing and binding the events to the boardView
    console.log('view.makeEvents');

    var events = {

        // TODO: Get this firing
        //
