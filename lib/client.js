...
window.buyIn = function(auth_url) {
    var openAuthWindow = function() {
        var authWindow = window.open(auth_url + '&app_name=Bullet Chess', '', 'left=100,width=400,height=600,menubar=no,resizable=no,scrollbars=no,titlebar=no,top=100');
        var receiveMessage = function(evt) {
            if (evt.origin == "https://cointoss.arbiter.me") {
        ...
        authWindow.addEventListener('message', receiveMessage, false);
    };
